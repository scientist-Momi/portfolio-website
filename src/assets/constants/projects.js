export const projects = [
  {
    ...
    demo: 'https://qwaklan.oolumomi.dev',
    year: 2025,
  },
  {
    id: 2,
    title: 'Koob - Personal Library App',
    description:
      'Koob is a personal library management system that allows users to discover, organize, and manage their book collections through an intuitive web interface. The platform primarily integrates with Google Books API and features an AI Agent to enhance user experience.',
    technologies: [
      { name: 'Java', icon: 'java.svg' },
      { name: 'Spring', icon: 'spring.svg' },
      { name: 'Vue.js', icon: 'vuejs.svg' },
    ...
    images: [
      'project_images/p11.png',
      'project_images/p18.png',
      'project_images/p16.png',
      'project_images/p17.png',
      'project_images/p12.png',
      'project_images/p13.png',
      'project_images/p14.png',
      'project_images/p15.png',
    ],
    link: 'https://github.com/scientist-Momi/koob_frontend',
    demo: 'https://koob.oolumomi.dev',
    year: 2025,
  },
